...
import pandas as pd
from LinePlot import PopulationLinePlot
...
SingleVoxelData = np.loadtxt(fr"SingleVoxelAdaptiveTherapy_0.5density_nocost_{SENSPOP}initsensitive_{RESPOP}initresistant1.csv", delimiter=",")
